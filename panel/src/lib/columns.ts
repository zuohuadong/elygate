...
const enumValueTranslations: Record<ElygateLocale, Record<string, Record<string, string>>> = {
	'zh-CN': {
		...
		auth_type: { none: '无', headers: '请求头凭证', oauth: 'OAuth', per_user_oauth: '用户 OAuth', per_user_headers: '用户请求头', token_exchange: '委托令牌交换' },
		connection_type: { stdio: '标准 IO', sse: 'SSE', http: 'HTTP' },
