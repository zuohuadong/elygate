...
const enumValueTranslations: Record<ElygateLocale, Record<string, Record<string, string>>> = {
	'zh-CN': {
		...
		auth_type: { none: '无', headers: '请求头凭证', oauth: 'OAuth', per_user_oauth: '用户 OAuth', per_user_headers: '用户请求头' },
	...
	en: {
		...
		auth_type: { none: 'None', headers: 'Header credentials', oauth: 'OAuth', per_user_oauth: 'Per-user OAuth', per_user_headers: 'Per-user headers' },
