...
<style>
	...
	select { background: var(--background); border: 1px solid var(--border); border-radius: .5rem; color: var(--foreground); flex: none; font: inherit; font-size: .82rem; max-width: 19rem; padding: .5rem .65rem; }
