...
<style>
	...
	.field-copy { display: grid; gap: .15rem; min-width: 0; }
	.field-label { color: var(--foreground); font-size: .85rem; font-weight: 600; }
	small { color: var(--muted-foreground); font-size: .72rem; line-height: 1.4; }
	input { background: var(--background); border: 1px solid var(--border); border-radius: .5rem; color: var(--foreground); flex: none; font: inherit; font-size: .82rem; max-width: 19rem; padding: .5rem .65rem; width: 100%; }
