...
<style>
	...
	th:nth-child(1) { width: 12%; } th:nth-child(2) { width: 22%; } th:nth-child(3) { width: 16%; } th:nth-child(4) { width: 8%; } th:nth-child(5) { width: 8%; } th:nth-child(6) { width: 14%; } th:nth-child(7) { width: 20%; }
