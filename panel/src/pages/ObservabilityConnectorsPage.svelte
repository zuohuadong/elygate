...
<section class="page-shell" data-resource={resourceName}>
	<header class="page-heading"><div><p class="eyebrow">Elygate / Observability</p><h1>{i18n.t('elygate.connectors')}</h1><p>{i18n.t('elygate.connectorsHint')}</p></div><button type="button" onclick={() => void load()}>{i18n.t('elygate.refresh')}</button></header>
