...
function PopoverContent({
	...
	// but does nothing. stopPropagation keeps the event local to the popover.
	...
	if (noPortal) {
		return (
			<PopoverPrimitive.Content
				...
				onWheel={handleWheel}
				className={cn(
					"bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-[100] max-h-(--radix-popover-content-available-height) w-72 origin-(--radix-popover-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-sm border p-4 shadow-md outline-hidden",
					className,
				)}
				{...props}
			/>
