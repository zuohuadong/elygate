...
export default function AlertChannelsView() {
	return (
		<AlertingPlaceholderView
			...
			description="This feature is a part of the Elygate enterprise license. Configure Slack, PagerDuty, OpsGenie, and webhook alerts to stay ahead of budget and performance issues."
