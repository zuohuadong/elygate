...
export default function AlertRulesView() {
	return (
		<AlertingPlaceholderView
			...
			description="This feature is a part of the Elygate enterprise license. Define alerting rules to catch budget, latency, and degradation issues before they become incidents."
