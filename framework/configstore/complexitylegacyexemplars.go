...
// Legacy semantic-routing exemplars are the exact v2 reference phrases used by
// migrationBackfillDefaultComplexityExemplars in migrations.go.
//
// This is a frozen migration snapshot, not the routing plugin's live catalog.
// The migration upgrades configurations written before semantic complexity
// routing existed, so changing these phrases later would make the same v2
// migration produce different results for different upgrade dates. Keep this
// list unchanged; a future catalog backfill needs its own versioned migration
// and its own frozen snapshot.
//
// The v2 exemplars are balanced along two axes at once.
//
...
// to itself. This snapshot preserves the reviewed v2 spread.
//
...
var legacySimpleExemplarsV2 = []string{
...
var legacyMediumExemplarsV2 = []string{
	// Coding and software engineering (14).
...
var legacyComplexExemplarsV2 = []string{
	// Coding and software engineering (14).
...
// legacyComplexityExemplarsV2 returns independent copies of the exact
// semantic-routing phrase set shipped with the v2 exemplar backfill.
func legacyComplexityExemplarsV2() ComplexityEditableKeywordConfig {
	return ComplexityEditableKeywordConfig{
		SimpleKeywords:  cloneLegacyExemplarsV2(legacySimpleExemplarsV2),
		MediumKeywords:  cloneLegacyExemplarsV2(legacyMediumExemplarsV2),
		ComplexKeywords: cloneLegacyExemplarsV2(legacyComplexExemplarsV2),
	}
}

func cloneLegacyExemplarsV2(values []string) []string {
