...
The Hugging Face provider supports routing to 19 inference backends. Below is the current list of supported providers and their capabilities (as of August 2026):
