---
title: "Check Point's AI Agent Security"
description: "Integrate Check Point's AI Agent Security with Bifrost to screen prompts and responses, enforce Check Point policies, and redact supported findings."
...
<Frame>
  <img src="/media/guardrails/lakera-policy-setup.png" alt="Check Point policies page showing policies, detector coverage, sensitivity, and assigned projects" />
</Frame>
...
<Frame>
  <img src="/media/guardrails/lakera-bifrost-config.png" alt="Check Point's AI Agent Security configuration in Bifrost showing required credentials and redaction controls" />
</Frame>
