...
<Note>
  In the **Attribute-to-Role Mappings** section, all matching rules are evaluated. If several rules match, Bifrost picks one using your chosen resolution strategy:
